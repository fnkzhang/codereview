...
located between lines {start_line} and {end_line} of the following code:
...
USER_INSTRUCTION_CODE_FROM_SUGGESTION_2 = """\
<suggestion>
{suggestion}
</suggestion>
"""

def get_llm_code_from_suggestion_2(code: str,
                                   language: str,
                                   start_line: int,
                                   end_line: int,
                                   suggestion: str):
    # Configure System Prompt
    system_prompt = SYSTEM_INSTRUCTION_CODE_FROM_SUGGESTION_2\
                        .format(code=get_code_with_line_numbers(code),
                                language=language,
                                start_line=start_line,
                                end_line=end_line)

    # Configure User Prompt
    user_prompt=USER_INSTRUCTION_CODE_FROM_SUGGESTION_2\
    ...
    print("Implemented Code Generated by AI:")
    print(revised_code)
    return revised_code
